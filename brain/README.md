...
docker run -d --name typedb -p 127.0.0.1:1729:1729 vaticle/typedb:2.29.1
...
# This installs typedb-driver==2.28.4 (TypeQL 2.x API), verified against
# TypeDB Core 2.29.1. Both sides are deliberately pinned.
```
